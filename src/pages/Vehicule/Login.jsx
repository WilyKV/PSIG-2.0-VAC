...
export default function LoginVehicule({ onLogin }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] bg-gradient-to-br from-slate-50 to-blue-50">
      <button
        type="button"
      ...
      <form onSubmit={handleSubmit} className="bg-white/90 rounded-xl shadow p-8 w-full max-w-xs flex flex-col gap-4 border border-slate-100">
        <h2 className="text-xl font-bold text-slate-800 mb-2 text-center">Connexion Véhicule</h2>
        <input
